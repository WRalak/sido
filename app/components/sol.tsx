...
export default function SolgatesShowcase() {
  ...
  const images = [
    { src: "/slg.jpg", alt: "Solgates Marketplace Interface" },
    { src: "/solg.jpg", alt: "Second-hand Clothing Listings" },
    { src: "/solgg.jpg", alt: "Second-hand Clothing Listings" },
  ];
  ...
  return (
    <div className="w-full max-w-[353px] mx-auto p-3 md:p-4 bg-[rgba(249,250,251,1)] relative">
      ...
      >
        ...
        <div className="flex flex-col justify-center overflow-hidden">
          <p className="text-[11px] md:text-[13px] mb-2 font-extrabold text-gray-800 whitespace-nowrap max-w-full font-Satoshi">
      ...
      <div className={`
        ...
        transition-all duration-300 ease-in-out py-8 px-3 sm:px-8 md:px-12 lg:px-20 lg:py-14
      ...
      style={{ 
        ...
        <div className="w-full">
          ...
          <div className="prose max-w-none">
            <h2 className="font-extrabold text-gray-700 text-[16px] sm:text-[20px] mt-2 mb-2 md:mb-4">Project Overview</h2>
            
            <h3 className="text-gray-900 font-bold text-[12px] sm:text-[13px] mb-1 md:mb-2">About Solgates</h3>
            <p className="text-gray-700 text-[10px] sm:text-[13px] font-medium">
            ...
            <p className="mb-2 md:mb-3 text-gray-700 font-medium text-[12px] sm:text-[13px]">My role encompassed:</p>
            <ul className="text-gray-700 text-[10px] sm:text-[13px] font-medium leading-relaxed">
            ...
            <p className="text-gray-700 text-[10px] sm:text-[13px] font-medium mt-3 md:mt-4">
