...
const LogoSection = () => {
  ...
  return (
    <section className="hidden sm:block w-full py-3   md:px-12 lg:px-44 px-4  overflow-hidden">
      <div className="max-w-6xl mx-auto">
        <div className="lg:ml-20 mb-6 lg:mb-8">
          <h2 className="font-satoshi font-bold text-[13px] lg:text-[13px] mb-2">Logos do tell tales</h2>
