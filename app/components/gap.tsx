...
export default function GapstackShowcase() {
  ...
  return (
    <div className="w-full max-w-[330px] mx-auto p-3 md:p-4 bg-[rgba(249,250,251,1)] relative">
      {/* Small Summary Section (Always visible) */}
      <div 
        className="flex items-center gap-2 md:gap-3 mb-4 md:mb-6 p-2 md:p-3 cursor-pointer"
      ...
      >
        ...
        <div className="flex flex-col justify-center leading-snug">
          <p className="text-[12px] md:text-[14px] mb-2 font-extrabold text-gray-800">
      ...
      <div className={`
        ...
        transition-all duration-300 ease-in-out py-8 px-3 sm:px-6 md:px-12 lg:px-20 lg:py-14
        ...
        <div key={idx} className="flex items-center gap-1 flex-nowrap">
          ...
          <div className="relative mt-4 md:mt-8 group">
            ...
            <div className="relative z-10 w-full h-[300px]">
              <div className="absolute inset-0" style={{ top: '26px', left: '36px', right: '36px', bottom: 0 }}>
          ...
          <div className="text-gray-700 font-[Satoshi] leading-relaxed mt-6">
            ...
            <p className="text-[14px] sm:text-lg md:text-[20px] font-extrabold mb-2 mt-3">
              Project Overview
            </p>

            <div className="text-[10px] md:text-[13px] mb-6">
              <strong>About Gapstack:</strong>
              <p className="font-medium">Gapstack is a supply chain and trade financing platform designed to help banks and financial <br /> institutions streamline their trade financing processes. The platform aims to reduce manual <br /> inefficiencies, enhance automation, and provide a seamless experience for financial professionals <br /> managing trade finance operations.</p>
            </div>

            <p className="text-[12px] sm:text-[14px] font-semibold mb-2">
              The Problem
            </p>
            <p className="text-[10px] sm:text-xs md:text-[13px] font-medium mb-4">
            ...
            <p className="text-[10px] sm:text-[13px] font-medium mb-6">
          ...
          <div className="text-gray-700 py-4 font-[Satoshi] leading-relaxed space-y-3 md:space-y-4">
            <h2 className="text-[14px] sm:text-[20px] font-extrabold">Research & Discovery</h2>

            <div>
              <h3 className="text-[12px] sm:text-[14px] font-semibold mb-1">Understanding Users</h3>
              <p className="text-[10px] sm:text-[13px] font-medium">
                To design a user-centered solution, I conducted extensive research, including:
              </p>
              <ul className="list-disc list-inside font-medium text-[10px] sm:text-[13px] space-y-1">
                <li>
            ...
            <div>
              <h3 className="text-[12px] sm:text-[14px] font-semibold mb-1">Competitive Analysis</h3>
              <p className="text-[10px] sm:text-[13px] font-medium">Through my study of existing trade finance solutions, I identified key gaps:</p>
              <ul className="list-disc font-medium list-inside text-[10px] sm:text-[13px] space-y-1">
            ...
            <div className="mt-6">
              <h3 className="text-[12px] sm:text-[14px] font-semibold mb-1">Key Insights</h3>
              <ul className="list-disc list-inside text-[10px] sm:text-[13px] font-medium space-y-1">
            ...
            <hr className="mt-7 text-gray-200" />
            <div className="mt-6">
              <h2 className="text-[14px] sm:text-[20px] font-extrabold mb-3">Design Process</h2>
              
              <div className="mb-4">
                <h3 className="text-[12px] sm:text-[14px] font-semibold mb-1">User Flow & Wireframing</h3>
                <p className="text-[10px] sm:text-[13px] font-medium">Based on my research insights, I designed user flows to streamline the financing application <br /> process, ensuring an intuitive journey from request submission to approval.</p>
              </div>

              <div className="mb-4">
                <h3 className="text-[12px] sm:text-[14px] font-semibold mb-1">UI Design</h3>
                <p className="text-[10px] sm:text-[13px] font-medium mb-2">My visual design emphasized:</p>
                <ul className="list-disc list-inside text-[10px] sm:text-[13px] font-medium">
              ...
              <div className="mb-4">
                <h3 className="text-[12px] sm:text-[14px] font-semibold mb-1">Prototyping</h3>
                <p className="text-[10px] sm:text-[13px] font-medium">I created interactive prototypes using Figma to simulate real-world interactions. These prototypes <br /> were tested with users to refine functionality before development.</p>
              </div>
            </div>
            <hr className="mt-7 text-gray-200" />
            <div className="mt-6">
              <h2 className="text-[14px] sm:text-[20px] font-extrabold mb-3">Testing & Iterations</h2>
              
              <div className="">
                <h3 className="text-[12px] sm:text-[14px] font-semibold mb-1">Usability Testing</h3>
                <p className="text-[10px] sm:text-[13px] font-medium">I conducted multiple testing rounds with financial users to identify pain points and areas for <br /> improvement.</p>
              </div>

              <div className="">
                <h3 className="text-[12px] sm:text-[14px] font-semibold mb-1">Findings & Improvements</h3>
                <ul className="list-disc list-inside text-[10px] sm:text-[13px] font-medium space-y-1">
            ...
            <div className="mt-6">
              <h2 className="text-[11px] sm:text-[13px] font-semibold mb-3">Impact & Outcome</h2>
              <ul className="list-disc list-inside text-[10px] sm:text-[13px] font-medium space-y-1">
            ...
            <hr className="mt-7 text-gray-200" />
            <div className="mt-6">
              <h2 className="text-[14px] sm:text-[20px] font-extrabold mb-3">Final Screens & Key Features</h2>
              <div className="mb-4">
                <h3 className="text-[12px] sm:text-[14px] font-semibold mb-1">Key UI Screens</h3>
                <ul className="list-disc list-inside text-[10px] md:text-[13px] font-medium space-y-1">
            ...
            <div className="mt-6">
              <strong className="text-[12px] sm:text-[14px] font-bold text-gray-700 mb-3">Key Learnings</strong>
              <ul className="list-disc list-inside text-[10px] md:text-[13px] font-medium space-y-1">
