...
<div className="flex overflow-x-auto whitespace-nowrap custom-scroll pb-2"> 
  <div className="inline-flex flex-shrink-0 w-[280px] sm:w-[320px] md:w-[340px] lg:w-[360px]"> 
    ...
    <div className="inline-flex pl flex-shrink-0 w-[280px] sm:w-[320px] md:w-[340px] lg:w-[360px] "> <Sol /> </div>
     <div className="inline-flex flex-shrink-0 w-[280px] sm:w-[320px] md:w-[340px] lg:w-[360px] "> <Cars /> </div>
      <div className="inline-flex flex-shrink-0 w-[280px] sm:w-[320px] md:w-[340px] lg:w-[360px] "> <Tuks />
       </div>
        </div>
         </div>
          </div>
