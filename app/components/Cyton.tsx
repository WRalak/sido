...
export default function CytonnExperience() {
  return (
    <div className="flex flex-col md:px-12  w-[700px] p-3 md:p-6">
  ...
  and building impactful digital products.
          ...
          <p className="text-gray-800 font-medium text-[13px] mt-2.5 text-justify">
          ...
          <p className="text-gray-800 font-medium text-[13px] text-justify mt-2">
            This role was instrumental in shaping my approach to <strong>user-centered design</strong> <br/> 
            and building impactful digital products.
          </p>
